...
employeeApp.controller('viewController',function($scope,employeeStorage){
	...
	$scope.gridOptions = {
		data:'myData',
		/*columnDefs: [{field:'fName',displayName:First Name},{field:'mName',displayName:Middle Name},{field:'lName',displayName:Last Name},
		             {field:'email',displayName:Email},{field:'location',displayName:Location},{field:'title',displayName:title},
